"""Crea una programa de Login que compruebe el usuario y contraseña en el diccionario predefinido.El usuario tendrá un máximo de 3 intentos, y al acceder correctamente se mostrará el nombre y apellido del usuario."""
